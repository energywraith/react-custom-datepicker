...
const PopoverButton: ButtonComponent = ({ children, disabled, className }: IPopoverButtonProps) => {
  ...
  return (
    <Button
      ...
      className={classNames(
        `w-72 border border-secondary-700 rounded-md shadow-xs flex items-center gap-x-2 px-4 py-2 ${
